...
export default class MyGame extends Phaser.Scene {
    ...
    create() {
        ...
        this.bords.create(0, 0, 'bords').setOrigin(0,0).setScale(1,1);
        this.bords.create(0, 550-32, 'bords').setOrigin(0,0).setScale(2,1);
        this.bords.create(32, 0, 'bords').setOrigin(0,0).setAngle(90);
        this.bords.create(978, 0, 'bords').setOrigin(0,0).setAngle(90);
